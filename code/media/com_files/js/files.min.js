...
){this.fireEvent("beforeSetPathway");var e=this.options.pathway;this.pathway=new Files.Pathway(e.element,e);var t=this,n=this.pathway;t.addEvent("afterSetTitle",function(e){if(!n.element)return;n.list.empty(),n.element.setStyle("visibility","hidden");var r=n.wrap(" "+t.container.title,"",!1,t).grab(new Element("i",{"class":"icon-hdd"}),"top"),i="";n.list.adopt(r);var s=t.getPath().split("/");s.each(function(e){e.trim()&&(i+=i?"/"+e:e,n.list.adopt(n.wrap(e,i,!0,t)))}),n.list.getLast().addClass("active"),n.element.setStyle("visibility","visible")}),this.fireEvent("afterSetPathway")},setTitle:function(e){this.fireEvent("beforeSetTitle",{title:e}),this.title=e,this.options.title&&this.options.title.set("html",e),this.fireEvent("afterSetTitle",{title:e})},createRoute:function(e){return e=$merge(this.options.router.defaults,e||{}),e.container!==!1&&!e.container&&this.container?e.container=this.container.slug:delete e.container,e.format=="html"&&delete e.format,"?"+(new Hash(e)).filter(function(e,t){return typeof e!="function"}).toQueryString()}});