 ...
 * Root file
 */
$result = KObjectManager::getObject('com://admin/files.controller.file')
 ...
 * Root folder
 */
$result = KObjectManager::getObject('com://admin/files.controller.folder')
	->container('files-files')
	->name('banners')
	->read()->toArray();
 ...
 * Root nodes
 */
$result = KObjectManager::getObject('com://admin/files.controller.node')
	->container('files-files')
	->limit(5)
	->browse()->toArray();
