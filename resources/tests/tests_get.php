 ...
 * Root file
 */
$result = KObjectManager::getInstance()->getObject('com:files.controller.file')
 ...
 * Root folder
 */
$result = KObjectManager::getInstance()->getObject('com:files.controller.folder')
	->container('files-files')
	->name('banners')
	->read()->toArray();
 ...
 * Root nodes
 */
$result = KObjectManager::getInstance()->getObject('com:files.controller.node')
	->container('files-files')
	->limit(5)
	->browse()->toArray();
